...
const TABLES = [
  ...
  { table: 'support_ticket_history', matchColumn: 'created_at' },
  { table: 'support_tickets', matchColumn: 'created_at' },
  { table: 'biometric_captures', matchColumn: 'created_at' },
  { table: 'access_events', matchColumn: 'created_at' },
  { table: 'access_grants', matchColumn: 'granted_at' },
  { table: 'kitchen_pick_list_items', matchColumn: 'created_at' },
  { table: 'kitchen_pick_lists', matchColumn: 'created_at' },
  { table: 'warehouse_boxes', matchColumn: 'updated_at' },
  { table: 'warehouse_racks', matchColumn: 'created_at' },
  { table: 'warehouse_rooms', matchColumn: 'created_at' },
