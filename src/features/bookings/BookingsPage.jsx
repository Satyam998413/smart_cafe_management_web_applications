...
export default function BookingsPage({ apiFetch }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
      <div>
        <h2 style={{ fontSize: '1.1rem', color: 'var(--text-primary)' }}>Bookings</h2>
        <p style={{ color: 'var(--text-secondary)', fontSize: '0.85rem', marginTop: '0.2rem' }}>Hotel room reservations across your organization.</p>
      </div>

      <div style={{ overflowX: 'auto' }}>
        <SegmentedToggle options={STATUS_TABS} value={statusFilter} onChange={setStatusFilter} style={{ minWidth: 'fit-content' }} />
      </div>
